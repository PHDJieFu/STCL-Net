...
parser = argparse.ArgumentParser(description='STCL-NET')
parser.add_argument('--path-dataset', type=str, default='/data_SSD1/fj/MM21/Thumos14', help='the path of data feature')
...
parser.add_argument('--model-name', default='THU_STCL_best', help='name to save model')
...
parser.add_argument('--use-model', type=str, default='STCL_THU', help='model used to train the network')                        # CO2
...
parser.add_argument('--dataset', type=str, default='SampleDataset')                                               # SampleDataset
...
parser.add_argument("--resultsName", type=str, default='thu_cas_att')