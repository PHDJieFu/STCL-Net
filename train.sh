...
CUDA_VISIBLE_DEVICES=0 python main.py --k 5  --dataset-name ActivityNet1.2 --path-dataset path/to/ActivityNet dataset --num-class number-of-actions --use-model STCL_ACT  --dataset AntSampleDataset --lr 3e-5 --max-seqlen 60 --model-name ACT_STCL_best --seed 3552 --max-iter 40000